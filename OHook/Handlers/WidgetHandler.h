...
public:
	...
	static std::vector<FGuid> KnownGoodGuids;
...
private:
	...
	static void ParseStoreContent(UWBP_PremiumStoreScreen_V2_CM_C*);
};
...
inline std::vector<FGuid> WidgetHandler::KnownGoodGuids = {};
